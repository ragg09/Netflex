$(document).ready(function() {
	...
	//calling genre index and puting it inside home index
    $('.genre_view').on('click',function(){
    	$('#content2').hide();
    	...
    	$.getScript("js/genre_afterload.js");

    });

    //web manipulation, calling genre.index file and load it to main index to maintain single page concept
    //both content 1 and 2 are divs inside main index
    //content 1 is just a div
    //content 2 displays Movies as my home/default 
     $('.genre_create').on('click',function(){
     	$('#content2').hide();
    	$('#content1').load('/genre/create');
    });
